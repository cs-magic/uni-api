...
class Simulator(Tracker):
    ...
    def run(self, content: str, user_name: str = None, user_avatar: str = None) -> str:
        try:
            ...
            self._send("card-user-name", "")
            self._send("card-user-avatar", "")
            self._send("card-content", "")
            self.track("reset content")
